...
let globalQuoteMap = global.quoteMap || new Map();
global.quoteMap = globalQuoteMap;
...
export default async function handler(req, res) {
  try {
    ...
    const currentQuote = globalQuoteMap.get(quoteId) || [];
    globalQuoteMap.set(quoteId, [...currentQuote, productToAdd]);
...
export { globalQuoteMap as quoteMap };
